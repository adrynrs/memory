...
namespace memory
{
    // Fenêtre modale affichée à la fin d'une partie (victoire ou game over).
    // Reçoit les stats (essais, secondes) et les affiche proprement avant de retourner au menu.
    public class ResultatForm : Form
    {
        ...
        private void InitialiserComposants(bool victoire, int essais, int secondes)
        {
            ...
            // Temps affiché seulement en cas de victoire
